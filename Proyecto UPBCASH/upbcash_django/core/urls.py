...
urlpatterns = [
    ...
    path("vendedor/tienda/", views.vendedor_tienda, name="vendedor_tienda"),
    ...
    path("staff/eventos/", views.staff_eventos, name="staff_eventos"),
    path("staff/mapa-asignacion/", views.staff_mapa_asignacion, name="staff_mapa_asignacion"),
    path("administrador/", views.admin_inicio, name="admin_inicio"),
    path("administrador/mapa/", views.admin_mapa, name="admin_mapa"),
    path("administrador/reportes/ventas/", views.admin_reportes_ventas, name="admin_reportes_ventas"),
    path("administrador/reportes/productos/", views.admin_reportes_productos, name="admin_reportes_productos"),
    path("administrador/reportes/clientes/", views.admin_reportes_clientes, name="admin_reportes_clientes"),
    path("administrador/reportes/operacion/", views.admin_reportes_operacion, name="admin_reportes_operacion"),
    path("administrador/reportes/export/<str:report>/", views.admin_reportes_export, name="admin_reportes_export"),
